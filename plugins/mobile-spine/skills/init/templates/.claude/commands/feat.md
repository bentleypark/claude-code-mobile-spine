...
## Policy reminders
- The `## Candidate assets` section in _tasks lists ~5 category keywords only (no codebase grep)
...
- Use the standard header (Case / Status / Android Issue / iOS Issue / Created / API Spec / Figma)
